...
class ArticleController extends AbstractController
{
    ...
    public function add(Request $request, EntityManagerInterface $em)
    {
        ...
        /*
         * handleRequest permet au formulaire de récupérer les données POST
    ...
    public function edit(Article $article, Request $request, EntityManagerInterface $em)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
             ...
             *      -> Doctrine connaît déjà cet objet (il existe en base de données)
    ...
    public function delete(Article $article, Request $request, EntityManagerInterface $em)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            /*
             * sprintf() sert à formatter une chaine de caractères
    ...
    public function publish(Article $article, string $token, EntityManagerInterface $em)
    {
         ...
         * Symfony va comparer le jeton qu'il a enregistré en session avec
         * ce que l'on a récupéré dans l'adresse
         */
